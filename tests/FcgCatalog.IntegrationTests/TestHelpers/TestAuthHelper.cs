...
{
    public const string CustomerEmail = "user@fcgcatalog.com";
    public const string AdminEmail = "admin@fcgcatalog.com";
    ...
    public static async Task<HttpClient> CreateInvalidRoleClientAsync(IntegrationTestFixture fixture)
    {
        ...
        var token = generator.Generate("guest@fcgcatalog.com", "Guest");
